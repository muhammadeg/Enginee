...
volatile bool WasJustConnected = false;
volatile bool WasJustDisconnected{ false };
volatile bool GotErrorMessage{false};
volatile bool WasJoinGame{false};
volatile bool WasSpectateGame{false};
volatile bool UpdatePresence{false};
